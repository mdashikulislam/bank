...
<?= $this->section('content') ?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Banks Monthly Target / Achievement Graph- Bar Chart Analysis</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Banking Bar Chart</h3>
            ...
            <!-- DONUT CHART -->
            <div class="card card-danger" style="display:none !important;">
              <div class="card-header">
          ...
          <div class="col-md-6">
            ...
            <!-- BAR CHART -->
            <div class="card card-success" style="display:none !important;">
              <div class="card-header">
