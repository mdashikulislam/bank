...
<nav class="mt-2">
  ...
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <?php if (hasPermissions('bank_banks')): ?>
      <li class="nav-item has-treeview <?php echo (@$_page->menu == 'banks') ? 'menu-open' : '' ?>">
        <a href="#" class="nav-link  <?php echo (@$_page->menu == 'banks') ? 'active' : '' ?>">
          <i class="nav-icon fas nav-icon fas fa-book"></i>
          <p>
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="<?php echo url('banks/add') ?>" class="nav-link <?php echo (@$_page->submenu == 'bank') ? 'active' : '' ?>">
              <i class="far fa-circle nav-icon"></i>
              <p> <?php echo lang('App.add_bank') ?> </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo url('locations/add') ?>" class="nav-link <?php echo (@$_page->submenu == 'locations_add') ? 'active' : '' ?>">
              <i class="far fa-circle nav-icon"></i>
              <p> <?php echo lang('App.locations_add') ?> </p>
            </a>
          </li>
          <li class="nav-item">
